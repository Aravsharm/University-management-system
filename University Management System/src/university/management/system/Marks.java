...
public class Marks extends JFrame implements ActionListener {
    ...
    Marks(String rollno) {
        ...
        JLabel lblsemester = new JLabel("Result of Examination 2023");
        ...
        try {
            Conn con = new Conn();
            ResultSet rs1 = con.stmt.executeQuery("select * from subject where rollno ='"+rollno+"'");
            while (rs1.next()) {
            ...
            ResultSet rs2 = con.stmt.executeQuery("select * from marks where rollno ='"+rollno+"'");
            while (rs2.next()) {
