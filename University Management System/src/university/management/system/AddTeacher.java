...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher() {
        ...
        JLabel labelcourse = new JLabel("Qualification");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "insert into teacher values('"+name+"','"+fname+"','"+empId+"','"+dob+"','"+phone+"','"+email+"','"+class_x +"','"+class_xii+"','"+aadhar+"','"+course+"','"+branch+"','"+address+"')";
                Conn con = new Conn();
