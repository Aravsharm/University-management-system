...
public class UpdateStudent extends JFrame implements ActionListener {
    ...
    UpdateStudent() {
        ...
        JLabel lebalrollno = new JLabel("Roll Number");
        ...
        try {
            Conn con = new Conn();
            String query = "select * from sumit where rollno='"+crollno.getSelectedItem()+"'";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                String query = "update sumit set address='"+address+"',phone='"+phone+"',email='"+email+"',course='"+course+"',branch='"+branch+"'";
                Conn con = new Conn();
                con.stmt.executeUpdate(query);

                JOptionPane.showMessageDialog(null, "Student details Updated Susseccfully");
                setVisible(false);
            } catch (Exception e) {
                e.printStackTrace();
            }
